...
class LcdtWidget extends StatefulWidget {
  const LcdtWidget({Key key}) : super(key: key);

  @override
  _LcdtWidgetState createState() => _LcdtWidgetState();
}

class _LcdtWidgetState extends State<LcdtWidget> {
